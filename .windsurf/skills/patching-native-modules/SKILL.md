---
name: patching-native-modules
description: Patches native modules (expo-image, react-native, etc.) to fix crashes or bugs. Use when analyzing iOS/Android crash logs, fixing native module issues, or generating patch files. Handles crash analysis, Swift/Kotlin code fixes, and patch-package workflow.
---
